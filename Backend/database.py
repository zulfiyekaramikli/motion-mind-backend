...
SessionLocal = sessionmaker(autocemmit = False , autoflush = False , bind = engine ) # bu satirlarda ayarlar yapildi  autocemmit veritabanina veri ekledigimizde aninda kayit yapmaz bize sorar evet dersek ekleme yapar bu sekilde yarim yamalak veri kaydetmenin önüne gecilir 
